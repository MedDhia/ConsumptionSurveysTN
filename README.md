...
| `tn_monthly_rebasing` | 288 | The measured ratio between the two industrial-price bases where they overlap. |
| `tn_rdit_estimates` | 355 | RDiT estimates of the January 2011 break, with bias-aware intervals and permutation tests. |
