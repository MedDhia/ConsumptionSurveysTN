...
INTROS = {
    ...
    "tn_yearbook_series": (
        ...
        "**Two table shapes.** Where the columns are years, `column_label` is that year "
        "and the table carries several years at once. Where the columns are a "
        "classification \u2014 age bands, indicator codes \u2014 the table describes a single "
        "year, taken from the page rather than from the edition's cover, and "
        "`column_label` is the category.\n\n"
